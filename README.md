...
This repository contains projects ideas from [Roadmap.sh](https://roadmap.sh/projects). 

## Project List

### HTML
- [Single-Page CV](https://github.com/jkvergara070781/roadmap.sh-projects/tree/main/html-projects/single-page-cv) - https://roadmap.sh/projects/single-page-cv
